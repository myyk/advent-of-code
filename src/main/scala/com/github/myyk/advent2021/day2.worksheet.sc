...
val input = com.github.myyk.readInput(2021,2)
...
// Construct Instruction from Strings where "forward" is R, "backward" is L, "down" is D, "up" is U
object Instruction {
...
directions.foreach {
  ...
  case Direction(L, value) => horizontalPosition -= value
